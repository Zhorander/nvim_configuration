local _2afile_2a = "/home/elias/.config/nvim/fnl/cosmonaut/util.fnl"
local _2amodule_name_2a = "cosmonaut.util"
local _2amodule_2a
do
...
local a, nvim = autoload("nfnl.core"), autoload("nfnl.nvim")
